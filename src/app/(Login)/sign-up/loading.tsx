export default function Loading() {
  return (
    <div className="flex min-h-dvh min-w-full items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className="text-center">
        ...
        <p className="mt-4 sm:mt-5 md:mt-6 text-sm sm:text-base md:text-lg font-medium text-gray-700">Preparando registro...</p>
      </div>
    </div>
  );
}
