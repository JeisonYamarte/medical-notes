        ...
        <>
            <Card className="w-[360px] h-auto flex flex-col gap-10">
                ...
                <CardContent className="flex flex-col gap-4">
                    <form id="formSignIn" onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="relative w-full">
                                <EyeOff className="absolute scale-90 left-2 top-1/2 transform -translate-y-1/2 font-light" />
                                <Input
                                className="pl-10 pr-3 py-2"
                                id="password"
                                type="password"
                ...
                <CardFooter className="flex flex-col gap-4 justify-center items-center">
                    ...
                    <CardAction className="w-auto mx-auto text-blue-500 font-semibold">¿No tienes una cuenta? Regístrate</CardAction>
                </CardFooter>
            </Card>
        </>
    );
